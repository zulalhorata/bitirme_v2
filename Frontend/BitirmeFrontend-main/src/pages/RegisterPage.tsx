...
const RegisterPage = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        const tcKimlikError = validateTcKimlik(formData.tcKimlik);
        ...
        if (!tcKimlikError && !passwordError && Object.values(formData).every(value => value !== '')) {
            const userData = {
            ...
            console.log('Kayıt olmaya çalışılan veriler:', userData);
            const success = authService.register(userData);
            console.log('Kayıt başarılı mı:', success);
            console.log('Mevcut kayıtlı kullanıcılar:', localStorage.getItem('registered_users'));
            ...
            if (success) {
                ...
                setErrors(prev => ({
                    ...prev,
                    submit: 'Bu TC Kimlik numarası ile daha önce kayıt yapılmış.'
                }));
            }
        }
    };
            ...
            <div className="w-[460px] mx-auto px-4">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-8">
                    <div className="flex mb-8 border-b">
                        <Link to="/giris" className="flex-1 text-center pb-3">
                            <span className="text-gray-500 font-medium text-lg">Giriş Yap</span>
                        </Link>
                        <div className="flex-1 text-center border-b-2 border-[#1B4332] pb-3">
                            <span className="text-[#1B4332] font-medium text-lg">Kayıt Ol</span>
                        </div>
                    </div>
